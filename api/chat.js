...
// NOTE: previously set to 'gemini-3.6-flash', which is not a real Gemini
// model id (doesn't exist in Google's lineup) — every request would have
// been failing at the API level. Reverted to match the model the README
// documents and that's confirmed to support Google Search grounding below.
const MODEL = 'gemini-3.6-flash'; // Google's Flash-tier model (multimodal, free-tier standard usage, supports Search grounding)
